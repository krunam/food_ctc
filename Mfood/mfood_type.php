  ...
  <div class="container-fluid">  
    ...
    <div class="collapse navbar-collapse" id="mynavbar">
      <ul class="navbar-nav me-auto">        
        <li class="nav-item">
          <a class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#myModal">เพิ่มหมวดหมู่อาหาร</a>
        </li>
      </ul>
      <form class="d-flex">
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-body">
                ...
                <div class="mb-3 mt-3">
                  <label for="CatName" class="form-label">ชื่อประเภทร้านอาหาร:</label>
                  <input type="text" class="form-control" id="CatName" name="CatName" placeholder="ชื่อ" name="email">
                </div>
                <div class="mb-3 mt-3">
                  <label for="StockLimit" class="form-label">รายประเภท:</label>
              ...
              <div class="modal-footer d-grid">
                 <button type="submit" name = "submit" class="btn btn-dark btn-block">เพิ่มประเภทร้านอาหาร</button>              
              </form>
              </div>
